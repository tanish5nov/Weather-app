...
function showWeaterReport(weather) {
    ...
    if(city_code==='404'){
        swal("Error!", "Please enter valid city", "warning");
        reset();
    }
    else{
...
function changeBg(status) {
    if (status === 'Clouds') {
        document.body.style.backgroundImage = 'url(img/clouds.gif)';
    } else if (status === 'Rain') {
        document.body.style.backgroundImage = 'url(img/rainy.gif)';
    } else if (status === 'Clear') {
        document.body.style.backgroundImage = 'url(img/clear.gif)';
    }
    else if (status === 'Snow') {
        ...
        document.body.style.backgroundImage = 'url(img/thunderstrom.gif)';
        ...
        document.body.style.backgroundImage = 'url(img/bag.gif)';
    }
}
